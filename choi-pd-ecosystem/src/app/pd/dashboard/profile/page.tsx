...
export default async function AdminProfilePage() {
  ...
  const profileData = {
    name: profileSettings.find(s => s.key === 'profile_name')?.value || '',
    title: profileSettings.find(s => s.key === 'profile_title')?.value || '',
    email: profileSettings.find(s => s.key === 'profile_email')?.value || '',
