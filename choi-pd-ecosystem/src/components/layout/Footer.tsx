      ...
      <div className="container py-12">
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 text-center text-sm text-gray-400">
          ...
          <div className="mt-3 flex flex-wrap items-center justify-center gap-4 text-xs">
            ...
            <span className="text-gray-200">|</span>
            <Link href="/legal/refund" className="hover:text-gray-600 transition-colors">환불정책</Link>
          </div>
          <div className="mt-3 flex flex-wrap items-center justify-center gap-4 text-xs text-gray-500">
            ...
            <span className="flex items-center gap-1">
              <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M2 12h20" /><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" /></svg>
              GDPR 준수
            </span>
          </div>
        </div>
